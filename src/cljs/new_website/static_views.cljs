...
(defcomponent welcome-page-view [state _]
  (render
    ...
    (dom/div
      ...
      (dom/p "Hi, I'm Conrad.")
      (dom/p
        (dom/span "I am a graduate student in physics working as part of the ")
        (dom/a {:href "http://research.physics.berkeley.edu/lanzara/"} "Lanzara Lab")
        (dom/span
          (str
    ...
    (dom/div
      ...
      (dom/div
        ...
        (dom/div
          ...
          (dom/p "chstan at berkeley.edu")
          (dom/p "chstansbury at lbl.gov"))))))
